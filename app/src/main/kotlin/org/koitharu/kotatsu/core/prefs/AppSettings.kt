...
class AppSettings @Inject constructor(@ApplicationContext context: Context) {
	...
	var isHidePartialChapters: Boolean
		get() = prefs.getBoolean(KEY_HIDE_PARTIAL_CHAPTERS, false)
		set(value) = prefs.edit { putBoolean(KEY_HIDE_PARTIAL_CHAPTERS, value) }
	...
	companion object {
		...
		const val KEY_HIDE_PARTIAL_CHAPTERS = "hide_partial_chapters"
